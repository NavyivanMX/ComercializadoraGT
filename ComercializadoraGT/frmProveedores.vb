Public Class frmProveedores
    ...
    Private Sub CARGASIGCLI()
        ...
        Dim QUERY As String
        Try
            QUERY = "SELECT MAX(CLAVE) FROM PROVEEDORES "
    ...
    Private Sub BTNGUARDAR_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        If TXTNOM.Text = "" Or TXTDIR.Text = "" Or TXTCD.Text = "" Or TXTTEL.Text = "" Or TXTCEL.Text = "" Or TXTFAX.Text = "" Or TXTRFC.Text = "" Or TXTBANCO.Text = "" Then
