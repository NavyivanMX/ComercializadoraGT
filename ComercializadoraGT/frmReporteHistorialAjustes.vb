Public Class frmReporteHistorialAjustes
    Dim CLAGRU As New List(Of String)
    Dim CLAPROD As New List(Of String)
    Private Sub frmReporteHistorialAjustes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGADATOS()
        ...
        Else
            ...
            End If
        End If
        QUERY = QUERY + " AND HA.TIENDA='" + frmPrincipal.SucursalBase + "' ORDER BY P.GRUPO,P.CLAVE "
    ...
    Private Function CARGAPRODUCTOS() As Boolean
        ...
        CLAPROD.Add("")
        Dim SQLPRO As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE FROM PRODUCTOS WHERE GRUPO='" + CLAGRU(CBGRU.SelectedIndex) + "' AND ACTIVO=1 AND EMPRESA=" + frmPrincipal.Empresa + " ORDER BY NOMBRE", frmPrincipal.CONX)
    ...
    Private Sub frmReporteHistorialAjustes_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
