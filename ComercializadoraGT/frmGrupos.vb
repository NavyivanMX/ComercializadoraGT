Public Class frmGrupos
    ...
    Private Sub CARGASIGGPO()
        ...
        Dim NUM As Integer
        NUM = 1
        Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGUIENTEGRUPO('" + frmPrincipal.Empresa + "')", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        End If
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,DESCRIPCION,ACTIVO,IMG FROM GRUPOS WHERE CLAVE=" + TXTCLA.Text + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
        LECTOR = SQLSELECT.ExecuteReader
        If LECTOR.Read Then
            TXTNOM.Text = LECTOR(1).ToString
            TXTDES.Text = LECTOR(2).ToString
            If LECTOR(3) = 1 Then
                CBACT.SelectedIndex = 1
            Else
                CBACT.SelectedIndex = 0
            End If
            TXTIMG.Text = LECTOR(4).ToString
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        If TXTNOM.Text = "" Or TXTDES.Text = "" Then
        ...
        SQLGUARDAR.Parameters.Add("@DES", SqlDbType.VarChar, 200).Value = TXTDES.Text
        SQLGUARDAR.Parameters.Add("@IMG", SqlDbType.VarChar, 200).Value = TXTIMG.Text
    ...
    Private Sub TXTNOM_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTNOM.KeyPress, TXTDES.KeyPress, TXTIMG.KeyPress
        If e.KeyChar = Chr(13) Then
            e.Handled = True
            SendKeys.Send("{TAB}")
        End If
