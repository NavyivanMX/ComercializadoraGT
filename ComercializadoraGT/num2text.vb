Public Class num2text
    Public Function Letras(ByVal numero As String) As String
        ...
        '************Quitar Comas*************
        For y = 1 To Len(numero)
            If Mid(numero, y + 1, 1) = "," Then
                numero = numero.Remove(y, 1)
            End If
        Next y
        ...
        If Val(numero) <= 999999999 Then
            ...
            If dec <> "" Then
                Letras = palabras & " pesos  " & dec + "/100"
            Else
                Letras = palabras + " pesos 00/100"
            End If
            Letras = Letras + " M.N."
            Dim PRIMERALETRA As String
            PRIMERALETRA = Letras.Substring(0, 1)
            PRIMERALETRA = PRIMERALETRA.ToUpper()
            Letras = Letras.Remove(0, 1)
            Letras = PRIMERALETRA + Letras
        Else
            Letras = ""
        End If
    End Function
