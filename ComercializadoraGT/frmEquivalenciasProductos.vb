Public Class frmEquivalenciasProductos
    ...
    Private Function CARGAPRODUCTO() As Boolean
        ...
        Dim SQLCARGAPROD As New SqlClient.SqlCommand("SELECT CP,NOMBRE FROM PRODUCTOS WHERE GRUPO='" + CLAGPO(CBGPO.SelectedIndex) + "' AND EMPRESA=" + frmPrincipal.Empresa + " AND ACTIVO=1 ORDER BY NOMBRE", frmPrincipal.CONX)
    ...
    Private Function CARGAGRUPO() As Boolean
        ...
        Dim SQLCARGAGPO As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE FROM GRUPOS WHERE EMPRESA=" + frmPrincipal.Empresa + " AND ACTIVO=1 ORDER BY NOMBRE", frmPrincipal.CONX)
    ...
    Private Sub GUARDAR()
        ...
        SQLBORRA.CommandText = "DELETE FROM EQUIVALENCIAS WHERE PRODUCTO=" + CLAPROD(CBPROD.SelectedIndex) + ""


        SQLBORRA.ExecuteNonQuery()

        SQLGUARDA.Parameters.Add("@EMP", SqlDbType.Int).Value = frmPrincipal.Empresa
    ...
    Private Sub CARGADATOS()
        ...
        SQLSELECT.CommandText = "SELECT G.NOMBRE,P.NOMBRE,E.CANTIDAD,U.NOMBRE,E.CANTIDAD2,L.NOMBRE  FROM EQUIVALENCIAS E INNER JOIN PRODUCTOS P  ON P.CP=E.PRODUCTO AND P.EMPRESA=E.EMPRESA  INNER JOIN GRUPOS G  ON G.CLAVE=p.GRUPO AND E.EMPRESA=G.EMPRESA   INNER JOIN UNIDADES U ON E.UNIDAD=U.CLAVE INNER JOIN LASUNIDADES L  ON E.UNIDAD2=L.CLAVE WHERE  E.PRODUCTO='" + CLAPROD(CBPROD.SelectedIndex) + "' "
    ...
    Private Sub frmEquivalenciasProductos_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.F10 Then
            ...
            If frmClsBusqueda.DialogResult = Windows.Forms.DialogResult.Yes Then
                OPCargaX(CLAGPO, CBGPO, frmClsBusqueda.TREG.Rows(0).Item(1).ToString)
