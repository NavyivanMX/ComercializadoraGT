Public Class frmEmpresa
    ...
    Private Sub CARGARDATOS()
        ...
        If LECTOR.Read Then
            ...
            TXTCOL.Text = LECTOR(23)
        End If
        LECTOR.Close()
    End Sub
    Private Sub GUARDARDATOS()
        Dim SQLUPDATE As New SqlClient.SqlCommand("MODIFICATIENDA", frmPrincipal.CONX)
        ...
        SQLUPDATE.Parameters.Add("@COL", SqlDbType.VarChar).Value = TXTCOL.Text

        If CBPT.SelectedIndex = 1 Then
    ...
    Private Sub TXTNF_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTNF.KeyPress, TXTNOM.KeyPress, TXTDIR.KeyPress, TXTRFC.KeyPress, TXTCP.KeyPress, TXTCD.KeyPress, TXTTEL.KeyPress, TXTFAX.KeyPress, TXTMAIL.KeyPress, TXTC1.KeyPress, TXTC2.KeyPress, TXTC3.KeyPress, TXTC4.KeyPress, TXTC5.KeyPress, TXTC6.KeyPress, TXTC7.KeyPress, TXTC8.KeyPress, TXTC9.KeyPress, TXTC10.KeyPress, TXTC11.KeyPress, TXTC12.KeyPress
