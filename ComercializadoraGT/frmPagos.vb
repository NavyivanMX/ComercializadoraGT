Public Class frmPagos
    ...
    Public CWA, COYR, FF, SERVADD, ASA As Boolean
    ...
    End Sub
    Public Sub MOSTRAR(ByVal VTOT As Double, ByVal VLTP As List(Of String), ByRef VCB As ComboBox, ByVal VLBAN As List(Of String), ByRef VCBB As ComboBox, ByVal SA As Boolean)
        LTP = VLTP
        LBAN = VLBAN
        TOT = VTOT
        TXTEFECTIVO.Text = ""
    ...
    Private Sub BTNCOBRAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNCOBRAR.Click
        ...
        'FF = True
        'If TP = 1 Then
        '    'Dim VPF As New frmMsg
        '    'VPF.MOSTRAR("Pedir factura", "Favor de responder", "¿Va a requerir factura?", False)
        '    'If VPF.DialogResult = Windows.Forms.DialogResult.Yes Then
        '    '    FF = True
        '    'Else
        '    '    FF = False
        '    'End If
    ...
    Private Function CHECACANTIDADES() As Boolean
        ...
        If CHKCE.Checked Then
            TXTTOT.Text = (frmPrincipal.PRE.Total * (1 + My.Settings.ServicioAdicional)).ToString
            SERVADD = True
        Else
            TXTTOT.Text = (frmPrincipal.PRE.Total).ToString
        End If
