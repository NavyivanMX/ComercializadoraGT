Public Class frmBancos
    ...
    Private Sub CARGASIGBANCO()
        ...
        Dim NUM As Integer
        NUM = 1
        Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGUIENTEBANCO()", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        End If
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,ACTIVO FROM BANCOS WHERE CLAVE=" + TXTCLA.Text + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        SQLGUARDAR.Parameters.Add("@NOM", SqlDbType.VarChar, 30).Value = TXTNOM.Text
        ...
        SQLGUARDAR.CommandText = "SPBANCOS"
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,ACTIVO FROM BANCOS  ", " WHERE NOMBRE", " ORDER BY NOMBRE", "Búsqueda de bancos", "Nombre del banco", "Banco(s)", 1, frmPrincipal.CadenaConexion, True)
