Public Class frmClsBusqueda2Campos
    Dim DT As New DataTable
    Dim DA As SqlClient.SqlDataAdapter
    Public TREG As New DataTable
    Dim VQUERY, VCAMPOBUS, VCAMPOBUS2, VQEXTRA, VNOMVEN, VLABELREG, VCADENA As String
    Dim VCOLUMNA As Integer
    Dim CONZ As New SqlClient.SqlConnection
    Private Sub frmClsBusqueda2Campos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub PONEFOCUS()
        TXTBUS.Focus()
    End Sub
    Public Sub BUSCAR(ByVal QUERY As String, ByVal CAMPOBUS As String, ByVal CAMPOBUS2 As String, ByVal QEXTRA As String, ByVal NOMVEN As String, ByVal LABELBUS As String, ByVal LABELREG As String, ByVal COLFILL As Integer, ByVal CADENA As String, ByVal MOSTRARINFO As Boolean)
        VCADENA = CADENA
        VLABELREG = LABELREG
        Try
            CONZ.Close()
    ...
    Private Sub TXTBUS_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTBUS.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            Else
                ...
                DT.Columns.Clear()
                Dim EXTRA As String
                EXTRA = VQUERY + VCAMPOBUS + " LIKE '%" + TXTBUS.Text + "%' OR " + VCAMPOBUS2 + " LIKE '%" + TXTBUS.Text + "%'" + VQEXTRA
