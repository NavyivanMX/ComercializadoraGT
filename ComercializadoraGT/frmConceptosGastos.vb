Public Class frmConceptosGastos
    ...
    Private Sub CARGASIGCON()
        Try
            ...
            Dim NUM As Integer
            NUM = 1
            Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGUIENTECONCEPTO('" + frmPrincipal.Empresa + "')", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT NOMBRE,DESCRIPCION,ACTIVO,SUMAR FROM CONCEPTOSGASTOS WHERE CLAVE='" + TXTCLA.Text + "' AND EMPRESA=" + frmPrincipal.Empresa + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
        ...
        If LECTOR.Read Then
            ...
            If CType(LECTOR(2), Boolean) Then
                CBACT.SelectedIndex = 0
            Else
            ...
            If CType(LECTOR(3), Boolean) Then
                cbsum.SelectedIndex = 0
            Else
                cbsum.SelectedIndex = 1
            End If
            BTNELIMINAR.Enabled = True
    ...
    Private Sub GUARDAR()
        ...
        SQL.Parameters.Add("@DES", SqlDbType.VarChar).Value = TXTDES.Text
        SQL.Parameters.Add("@ACT", SqlDbType.Bit)
        SQL.Parameters.Add("@SUM", SqlDbType.Bit)
        ...
        If cbsum.SelectedIndex = 0 Then
            SQL.Parameters("@SUM").Value = 1
        Else
            SQL.Parameters("@SUM").Value = 0
        End If
    ...
    Private Sub BTNBUSCAR_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,DESCRIPCION,SUMAR FROM CONCEPTOSGASTOS WHERE EMPRESA=" + frmPrincipal.Empresa + " ", " AND NOMBRE", " ORDER BY NOMBRE", "Búsqueda de Conceptos", "Nombre de Concepto", "Concepto(s)", 1, frmPrincipal.CadenaConexion, True)
    ...
    Private Sub BTNELIMINAR_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If xyz = 6 Then
            Try
                ...
                SQLELIMINAR.CommandText = "DELETE FROM CONCEPTOSGASTOS WHERE CLAVE='" + TXTCLA.Text + "' AND EMPRESA=" + frmPrincipal.Empresa + ""
    ...
    Private Sub TXTNOM_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTNOM.KeyPress, TXTDES.KeyPress, CBACT.KeyPress, cbsum.KeyPress
        If e.KeyChar = Chr(13) Then
            e.Handled = True
            SendKeys.Send("{TAB}")
        End If
