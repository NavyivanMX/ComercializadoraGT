...
Public Class rptReporteVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ComercializadoraGTFernandoSr.rptReporteVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteVentas = New rptReporteVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
