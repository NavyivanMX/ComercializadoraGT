Public Class clsPedido
    ...
    Public Sub New()
        ...
        DT.Columns.Add("CU")
    End Sub
    Public Sub AgregaQuita(ByVal PRO As String, ByVal Cantidad As Double, ByVal Sumar As Boolean)
        Dim Cant As Double
        Cant = 0
        For X = 0 To DT.Rows.Count - 1
            If DT.Rows(X).Item(6) = PRO Then
                If Sumar Then
        ...
        VerificarDT()
    End Sub
    Public Sub ModificaCantidad(ByVal PRO As String, ByVal Cantidad As Double, ByVal CantidadTotal As Double)
        Dim CP As Double
        CP = 0
        For X = 0 To DT.Rows.Count - 1
            If DT.Rows(X).Item(7) = PRO Then
                CP = DT.Rows(X).Item(5)
        ...
        VerificarDT()
    End Sub
    Public Sub Agregar(ByVal PRO As String, ByVal CANT As Double, ByVal UNI As String, ByVal CANTOT As Double, ByVal EXIS As Double, ByVal CPROM As Double, ByVal TOT As Double, ByVal CP As String, ByVal CU As String)
        ...
        Dim Total As Double
        For X = 0 To DT.Rows.Count - 1
            If DT.Rows(X).Item(7) = CP Then
                If DT.Rows(X).Item(8) = CU Then
                    Encontrado = True
