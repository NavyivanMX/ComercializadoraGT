Public Class frmBusquedaSeleccionMultiple
    ...
    Dim VMULTIPLESCOLUMNAS, NCOLUMNA As Integer
    ...
    Private Sub AGREGAR(ByVal IND As Integer)
        ...
        If Not ENC Then
            ...
            End If
            Try
                CLBEMP.SelectedIndex = CLBEMP.Items.Count - 1

            Catch ex As Exception

            End Try
        End If
        LBLRS.Text = CLBEMP.Items.Count.ToString + " Registros seleccionados"
    End Sub
