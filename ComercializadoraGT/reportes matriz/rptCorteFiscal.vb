...
Public Class rptCorteFiscal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PriceMarket.rptCorteFiscal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCorteFiscal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCorteFiscal = New rptCorteFiscal
        rpt.Site = Me.Site
        Return rpt
    End Function
