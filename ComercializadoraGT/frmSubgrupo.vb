Public Class frmSubgrupo

    Private Sub frmSubgrupo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGASIGGPO()
        Try
            ...
            Dim NUM As Integer
            NUM = 1
            Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGUIENTESUBGRUPO('" + frmPrincipal.Empresa + "')", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        frmPrincipal.CHECACONX()
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,ACTIVO FROM SUBGRUPOS WHERE CLAVE=" + TXTCLA.Text + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
    ...
    Private Sub GUARDAR()
        ...
        SQLGUARDAR.CommandText = "SPSUBGRUPOS"
    ...
    Private Sub ELIMINAR()
        ...
        If xyz = 6 Then
            Try
                ...
                SQLELIMINAR.CommandText = "DELETE FROM SUBGRUPOS WHERE CLAVE=" + TXTCLA.Text + " AND EMPRESA =" + frmPrincipal.Empresa + ""
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,ACTIVO FROM SUBGRUPOS WHERE EMPRESA=" + frmPrincipal.Empresa + " ", " AND NOMBRE", " ORDER BY NOMBRE", "Búsqueda de Sub Grupos", "Nombre del Sub Grupo", "Sub Grupo(s)", 1, frmPrincipal.CadenaConexion, True)
    ...
    Private Sub frmSubgrupo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
