...
Public Class rptFacturaElectronica3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacturaElectronica3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ComercializadoraGTFernandoSr.rptFacturaElectronica3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property PageFooterSection8() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedrptFacturaElectronica3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaElectronica3 = New rptFacturaElectronica3()
        rpt.Site = Me.Site
        Return rpt
    End Function
