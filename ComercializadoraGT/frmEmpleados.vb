Public Class frmEmpleados
    ...
    Private Sub CARGASIGEMP()
        ...
        Dim QUERY As String
        Try
            QUERY = "SELECT MAX(CLAVE) FROM EMPLEADOS WHERE TIENDA='" + frmPrincipal.SucursalBase + "'" ''---> Y PARA K TE SIRVE EL CAMPO TIENDA EN LA TABLA EMPLEADOS???? WHERE E.TIENDA='"+FRMPRINCIPAL.SUCURSALBASE+"'"
    ...
    Private Sub CARGADATOS()
        ...
        End If
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,DIRECCION,TELEFONO,CIUDAD,PUESTO,FECNAC,FECING,FECSAL,NOSS,TIPOSANGRE,FAMILIAR,ACTIVO FROM Empleados WHERE TIENDA='" + frmPrincipal.SucursalBase + "' AND CLAVE=" + TXTCLA.Text, frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
        LECTOR = SQLSELECT.ExecuteReader
        If LECTOR.Read Then
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,PUESTO,ACTIVO FROM EMPLEADOS WHERE TIENDA='" + frmPrincipal.SucursalBase + "'", " AND NOMBRE", " ORDER BY NOMBRE", "Búsqueda de Empleados", "Nombre del Empleado", "Empleado(s)", 1, frmPrincipal.CadenaConexion, True)
