Public Class frmEntrarCaja
    ...
    Private Sub CHECACAJERA()
        ...
        Dim PWD As String
        PWD = ""
        Dim SQL As New SqlClient.SqlCommand("SELECT C.PWD,E.NOMBRE FROM CAJERAS C INNER JOIN EMPLEADOS E ON C.TIENDA=E.TIENDA AND C.EMPLEADO=E.CLAVE WHERE C.TIENDA='" + frmPrincipal.SucursalBase + "' AND C.EMPLEADO=" + TXTEMP.Text, frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
        LECTOR = SQL.ExecuteReader
        If LECTOR.Read Then
            PWD = LECTOR(0)
