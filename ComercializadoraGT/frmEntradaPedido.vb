Public Class frmEntradaPedido
    Dim X As Integer
    Dim TABLAPRIN As New DataTable
    Dim TABLATEMP As New DataTable

    Private Sub frmEntradaPedido_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CHECATABLA()
        Dim TP As Double
        TP = 0
        LBLART.Text = "Artculos: " + DGV.Rows.Count.ToString
    ...
    End Sub
    Private Function CHECAPEDIDO() As Boolean
    ...
    Private Sub CARGADATOS()
        ...
        Dim QUERY As String
        QUERY = "SELECT DBO.ULTIMOLOTE(D.CP)LOTE,P.NOMBRE PRODUCTO,D.CANTIDAD,U.NOMBRE UNIDAD,RECIBIDO=CONVERT(BIT,1),L.COSTOU,TOTAL=D.TOTAL,D.REGISTRO FROM DETALLEPEDIDOS2 D INNER JOIN LOTES L ON DBO.ULTIMOLOTE(D.CP)=L.CLAVE INNER JOIN PRODUCTOS P ON L.PRODUCTO=P.CP INNER JOIN UNIDADES U ON D.UNIDAD=U.CLAVE  WHERE D.NOPEDIDO=" + LBLPED.Text + "  ORDER BY P.NOMBRE"
    ...
    Private Sub LBLPED_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles LBLPED.KeyPress
        ...
        End If
    End Sub
    Private Function PEDIDOAGREGADO() As Boolean
        If Not frmPrincipal.CHECACONX Then
            Exit Function
        End If
        Dim NPED As Integer
        ...
        Try
            For X = REN To DGV.Rows.Count - 1
                If DGV.Item(4, X).Value = True Then
                    ...
                    Dim SQL2 As New SqlClient.SqlCommand("UPDATE DETALLEPEDIDOS2 SET RECIBIDO=1,CANTR='" + DGV.Item(2, X).Value.ToString + "',USUARIORECIBE='" + frmPrincipal.Usuario + "',FECHARECIBIDO=GETDATE() WHERE NOPEDIDO=" + LBLPED.Text + " AND REGISTRO='" + DGV.Item(7, X).Value.ToString + "' ", frmPrincipal.CONX)
    ...
    Private Sub BTNBUS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUS.Click
        ...
        Dim query As String
        query = "SELECT NOPEDIDO,TIENDA,FECHA, TIPO, ESTADO  FROM VISTAPEDIDOS WHERE FECHA>='" + FECHA + "' AND SUCURSAL='" + frmPrincipal.SucursalBase + "' AND CE=3 "
    ...
    Private Sub LBLTOTPED_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLTOTPED.Click

    End Sub
    Private Sub Label4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label4.Click

    End Sub
    Private Sub LBLSUC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLSUC.Click

    End Sub
    Private Sub LBLTP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLTP.Click

    End Sub
    Private Sub LBLPED_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLPED.TextChanged

    End Sub
    Private Sub DGV_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGV.CellContentClick

    End Sub
    Private Sub LBLART_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLART.Click
