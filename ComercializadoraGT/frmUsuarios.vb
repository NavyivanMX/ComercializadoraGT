Public Class frmUsuarios
    ...
    Private Sub frmUsuarios_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      OPVisualizacionForm(Me)
        OPLlenaComboBox(CBNIV, LNIV, "SELECT PERFIL,NOMBRE FROM PERFILES WHERE SISTEMA=1 AND ACTIVO=1", frmPrincipal.CadenaConexion)
        NUEVO(True)
        ACTIVAR(True)
    End Sub
    ...
    Private Sub CARGAR()
        ...
        Dim SQL As New SqlClient.SqlCommand("SELECT PASSWORD,NIVEL,PERFIL FROM USUARIOS WHERE TIENDA='" + frmPrincipal.SucursalBase + "'AND USUARIO='" + TXTEMP.Text + "'", frmPrincipal.CONX)
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If TXTANT.Visible Then
            Dim SQL As New SqlClient.SqlCommand("UPDATE USUARIOS SET PASSWORD='" + TXTPWD.Text + "',PERFIL='" + LNIV(CBNIV.SelectedIndex) + "' WHERE TIENDA='" + frmPrincipal.SucursalBase + "' AND USUARIO='" + TXTEMP.Text + "'", frmPrincipal.CONX)
            SQL.ExecuteNonQuery()
        Else
            NIVEL = 5

            Dim SQL As New SqlClient.SqlCommand("INSERT INTO USUARIOS (USUARIO,PASSWORD,TIENDA,NIVEL,ACTIVO,PERFIL) VALUES ('" + TXTEMP.Text + "','" + TXTPWD.Text + "','" + frmPrincipal.SucursalBase + "'," + NIVEL.ToString + ",1,'" + LNIV(CBNIV.SelectedIndex) + "')", frmPrincipal.CONX)
            SQL.ExecuteNonQuery()
        End If
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If mens = 6 Then
            Dim sql As New SqlClient.SqlCommand("delete from USUARIOS where USUARIO = @usu AND TIENDA='" + frmPrincipal.SucursalBase + "'", frmPrincipal.CONX)
    ...
    Private Sub frmUsuarios_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Alt + Keys.G Then
            ...
            End If
            If TXTANT.Visible Then
                Dim SQL As New SqlClient.SqlCommand("UPDATE USUARIOS SET PASSWORD='" + TXTPWD.Text + "' WHERE TIENDA='" + frmPrincipal.SucursalBase + "' AND USUARIO='" + TXTEMP.Text + "'", frmPrincipal.CONX)
                SQL.ExecuteNonQuery()
            Else
                ...
                Else
                    NIVEL = "5"
                End If
                Dim SQL As New SqlClient.SqlCommand("INSERT INTO USUARIOS (USUARIO,PASSWORD,TIENDA,NIVEL,ACTIVO) VALUES ('" + TXTEMP.Text + "','" + TXTPWD.Text + "','" + frmPrincipal.SucursalBase + "'," + NIVEL.ToString + ",1)", frmPrincipal.CONX)
                SQL.ExecuteNonQuery()
            End If
