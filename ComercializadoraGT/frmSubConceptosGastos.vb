Public Class frmSubConceptosGastos
    ...
    Private Sub CARGASIGSUBCON()
        Try
            ...
            Dim NUM As Integer
            NUM = 1
            Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGUIENTESUBCONCEPTO('" + frmPrincipal.Empresa + "')", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT NOMBRE,ACTIVO FROM SUBCONCEPTOSGASTOS WHERE CLAVE='" + TXTCLA.Text + "' AND EMPRESA=" + frmPrincipal.Empresa + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
    ...
    Private Sub GUARDAR()
        ...
        SQL.Parameters.Add("@EMP", SqlDbType.VarChar).Value = frmPrincipal.Empresa
    ...
    Private Sub BTNELIMINAR_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If xyz = 6 Then
            Try
                ...
                SQLELIMINAR.CommandText = "DELETE FROM SUBCONCEPTOSGASTOS WHERE CLAVE='" + TXTCLA.Text + "' AND EMPRESA=" + frmPrincipal.Empresa + ""
